...
import com.example.mywallpaper.domain.tools.WallpaperSetter
...
class PhotoDownloadingUseCase(
    ...
    fun callManagerToDownloadPhotoByFLow(
        ...
        val photoDirPath = Environment.getExternalStorageDirectory().toString() + "/My Wallpaper"
        ...
        val downloadRequest = DownloadManager.Request(downloadUrl)
            ...
            .setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS,Uri.fromFile(photoFile).toString())
